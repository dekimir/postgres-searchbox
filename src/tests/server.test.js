...
describe('initTestDatabase', () => {
    ...
    it('should create the vector column and index', async () => {
        ...
        const indexSql = format('SELECT * FROM pg_indexes WHERE tablename = %L AND indexname = %L', tableName, 'postgres_searchbox_v1_idx_test_table');
    ...
    it('should return results', async () => {
        ...
        const req = { body: JSON.stringify({ params: { query }, indexName: tableName }) };
        const res = {
